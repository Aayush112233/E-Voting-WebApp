...
const ManageCanidate = ({
  ...
  const handleAddCandidate = () => {
    if (candidates.length > 0) {
      ...
      API.put("/election/updateCandidateDetails/" + electionId, data)
        .then((res) => {
        ...
        <Grid container spacing={2}>
          ...
          <Grid item xs={12} sm={6}>
            <TextField
              ...
              defaultValue={positionDetails[0]?.positionName}
              ...
              fullWidth
            >
              {positionDetails.map((option, index) => (
                <MenuItem
          ...
          <Grid item xs={12} sm={3}>
            <Button
              ...
              endIcon={
                <GrAdd style={{ position: "relative", color: "white" }} />
              }
            >
              Add to table
            </Button>
